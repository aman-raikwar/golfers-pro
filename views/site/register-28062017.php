...
<!--                                                  
                                                            ...
                                                            <select class="form-control" id="field-1">
                                                             ...
                                                             <?php  $dataList=ArrayHelper::map(GolfCourse::find()->asArray()->all(), 'ID', 'Name');?>
                                                            <?=$form->field($model, 'FirstClubID')->dropDownList($dataList,  ['prompt'=>'-Select Golf Club-']) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
<!--                                                            <label for="field-3" class="control-label">Select Golf Club</label>
                                                    ...
                                                    <?php  $dataList=ArrayHelper::map(GolfCourse::find()->asArray()->all(), 'ID', 'Name');?>
                                                   <?=$form->field($model, 'OtherClubName')->dropDownList($dataList,  ['prompt'=>'-Select Golf Club-']) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
<!--                                                            <label for="field-15" class="control-label">Address Line 2</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    <?php  $dataList=ArrayHelper::map(Country::find()->asArray()->all(), 'id', 'nationality');?>
                                                    <?=$form->field($model, 'Country')->dropDownList($dataList,  ['prompt'=>'-Select Country-']) ?>
