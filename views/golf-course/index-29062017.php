                    ...
                    <div class="portlet">
                        <div class="portlet-heading bg-inverse">
                            <h3 class="portlet-title">
                                Golf Club Overview123
                            </h3>
                            <div class="portlet-widgets">
                                <a href="<?= Url::base()."/golf-clubs/add-club" ?>" data-toggle="modal" data-target="#myModal"><i class="mdi mdi-plus"></i></a>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?= $form->field($model, 'IsAdmin')->textInput(['class' => "form-control", "id" => "IsAdmin"])->label(false) ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?= $form->field($model, 'Password')->textInput(['class' => "form-control", "id" => "Password"])->label(false) ?>
...
<!--<input type="text" class="form-control" id="field-6">-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?= $form->field($model, 'Address1')->textInput(['class' => "form-control", "id" => "Address2"])->label(false) ?>
